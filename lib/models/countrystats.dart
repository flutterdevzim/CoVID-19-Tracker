...
class DateUpdated {
  ...
  factory DateUpdated.fromJson(Map<String, dynamic> json) =>
      DateUpdated(date: json["date"]);
}
...
class ProvinceCases {
  ...
  ProvinceCases(
      ...
      this.manicaland,
      // ignore: non_constant_identifier_names
      this.mashonaland_central,
      // ignore: non_constant_identifier_names
      this.mashonaland_east,
      // ignore: non_constant_identifier_names
      this.mashonaland_west,
      this.masvingo,
      // ignore: non_constant_identifier_names
      this.matabeleland_north,
      // ignore: non_constant_identifier_names
      this.matabeleland_south,
      this.midlands});
  factory ProvinceCases.fromJson(Map<String, dynamic> json) => ProvinceCases(
      bulawayo: json["Bulawayo"],
      harare: json["Harare"],
      manicaland: json["Manicaland"],
      mashonaland_central: json["Mashonaland_Central"],
      mashonaland_east: json["Mashonaland_East"],
      mashonaland_west: json["Mashonaland_West"],
      masvingo: json["Masvingo"],
      matabeleland_north: json["Matabeleland_North"],
      matabeleland_south: json["Matabeleland_South"],
...
class CurrentCases {
  ...
  CurrentCases(
      ...
      this.minimumAge,
      this.maximumAge});
  factory CurrentCases.fromJson(Map<String, dynamic> json) => CurrentCases(
      totalTests: json["TotalTests"],
      positiveCases: json["PositiveCases"],
      negativeCases: json["NegativeTests"],
      deaths: json["Deaths"],
      icu: json["ICU"],
...
class CasesBySex {
  ...
  factory CasesBySex.fromJson(Map<String, dynamic> json) =>
      CasesBySex(male: json["male"], female: json["female"]);
}
...
class PositiveCases {
  ...
  PositiveCases(
      ...
      this.source,
      this.symptoms,
      this.dateOfSymptomsOnset,
      this.dateOfAdmission,
      this.dateOfConfirmation,
      this.underlyingConditions,
      this.travelHistoryDates,
      this.travelHistoryLocation,
      this.dateOfDeath,
      this.notes});
