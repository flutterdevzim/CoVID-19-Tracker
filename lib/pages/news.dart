                  ...
                  Container(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Text(item[index]['author'], style: TextStyle(
                              color: Colors.white
                            ),),
                            SizedBox(
                              width: 10,
                            ...
                            Text(item[index]['source']['name'], style: TextStyle(
                    ...
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                            ...
                            colors: [Colors.lightBlue, Colors.purple.withOpacity(.3)]
                        )
                    ),
                  )
                ],
